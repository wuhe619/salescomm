...
@Entity
@Table(name = "lkcrm_oa_examine_record", schema = "crm", catalog = "")
public class LkCrmOaExamineRecordEntity {
    ...
    public boolean equals(Object o) {
        ...
        LkCrmOaExamineRecordEntity that = (LkCrmOaExamineRecordEntity) o;

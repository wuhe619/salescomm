 ...
 */
@Service("CreateCustomGroupService")
@Transactional
public class CustomGroupServiceImpl {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            if (StringUtil.isEmpty(name)) {
                LogUtil.warn("客户" + custId + "创建客户群name参数为空,name:" + name);
                json.put("code", -2);
            ...
            insertOrder.append(" VALUES ('" + orderId + "','" + custId + "','1','" + new Timestamp(time) + "','客户群创建','0','2','0')");

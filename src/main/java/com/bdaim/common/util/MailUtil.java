...
public class MailUtil {
	...
	private static String MAIL_HOST = "smtp.bdcsdk.com";
	private static String MAIL_FROM = "ceshi1@bdcsdk.com";
	private static String USERNAME = "ceshi1@bdcsdk.com";
	private static String PASSWORD = "Ztwj12345";
	...
	public static void main(String[] args) {
		...
		mail.sendout("快推数据", "快推数据", "jiangd@bdcsdk.com");
	}
}
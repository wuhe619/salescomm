 ...
 * 巡检任务api资源
 */
@Service("busi_patrol_task_callapi_history")
@Transactional
public class PatrolTaskApisCallHistoryService implements BusiService {
    private static Logger log = LoggerFactory.getLogger(PatrolTaskApisCallHistoryService.class);

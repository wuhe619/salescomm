...
//                multipartFile.transferTo(file);
    ...
    public Map<String, Object> batchDetail(Map<String, Object> map) {
        ...
        StringBuffer hql = new StringBuffer("SELECT t2.label_four,t2.label_five,(case when STR_TO_DATE(t2.label_eight, '%Y-%m-%d %H:%i:%s')<now() then '有效' else '已过期' end) effectStatus,t2.touch_id touchId,t2.id AS addressId,l.request_id,t2.label_five AS receiverId,t2.batch_id AS batchId,t2.label_one AS name,t2.label_two AS phone,t2.site AS address," +

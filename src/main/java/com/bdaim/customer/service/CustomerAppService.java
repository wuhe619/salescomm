...
//            BigDecimal bigDecimal1 = new BigDecimal(Double.valueOf(customerProperty.getPropertyValue()));
    ...
    public Map<String, Object> customerMonthBill(PageParam page, String customerId){
        StringBuffer sb = new StringBuffer("select cust_id as custId,stat_time statTime,type,amount/1000 amount,certificate_pic certificatePic,actual_consumption_amount actualConsumptionAmount,op_time opTime,op_user opUser from stat_bill_month where cust_id=? and type=").append(TransactionTypeEnum.API_DEDUCTION.getType());

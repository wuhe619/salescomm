package com.bdaim.customer.service.impl;
...
import com.bdaim.customer.entity.CommonInfoPropertyDO;
    ...
    public Page searchSettlementList(String serviceCode, int pageNum, int pageSize, String projectId, String customerId, String jobId, String billDate, LoginUser lu) {
        ...
        if (page != null && page.getData() != null && page.getData().size() > 0) {
            ...
            for (SettlmentDTO o : list) {
                CommonInfoPropertyDO v = findCommonInfoProperty(serviceCode, null, "jobPrice", o.getProjectId(), o.getCustId(), o.getJobId());
                if (v != null) {
                    ...
                    CommonInfoPropertyDO remarkobj = findCommonInfoProperty(serviceCode, v.getZid().toString(), "remark", o.getProjectId(), o.getCustId(), o.getJobId());
                    if (remarkobj != null) {
                    ...
                    CommonInfoPropertyDO log = findCommonInfoProperty(serviceCode, v.getZid().toString(), "updatePriceLog", o.getProjectId(), o.getCustId(), o.getJobId());
                    if (log != null) {
...
//            page.setTotal(totalCount);
    ...
    public Page pageCommonInfoSearch(String serviceCode, int pageNum, int pageSize, String projectId, String customerId,
        ...
        if (page != null && page.getData() != null && page.getData().size() > 0) {
            List<CommonInfoPropertyDO> list = page.getData();
            for (CommonInfoPropertyDO infoPropertyDO : list) {
                ...
                if (CommonInfoServiceCodeEnum.JOB_SETTLEMENT_MANAGE.getKey().equals(serviceCode)
                    ...
                    List<CommonInfoPropertyDO> doList = findCommonInfoPropertyByzid(infoPropertyDO.getZid().toString());
                    if (doList == null) {
                        return page;
                    }
                    dto.setZid(infoPropertyDO.getZid().toString());
                    dto.setServiceCode(serviceCode);
                    for (CommonInfoPropertyDO doObj : doList) {
    ...
    private Integer getCountJobSettlementNumbyPid(String pid, String serviceCode) {
        List<CommonInfoPropertyDO> list = getJobSettlementListbyPid(pid, serviceCode);
        if (list == null || list.isEmpty()) {
            return null;
        }
        Integer total = 0;
        for (CommonInfoPropertyDO infoPropertyDO : list) {
            CommonInfoPropertyDO obj = findCommonInfoProperty(serviceCode, infoPropertyDO.getZid().toString(), "jobSettlementNum", null, null, null);
            if (obj != null) {
     ...
     * @return
     */
    private List<CommonInfoPropertyDO> getJobSettlementListbyPid(String pid, String serviceCode) {
        String sql = "select * from t_common_info_property where property_name='pid' " +
                "   and property_value='" + pid + "' and service_code='" + serviceCode + "'";
        List<CommonInfoPropertyDO> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(CommonInfoPropertyDO.class));
...
//            page.setTotal(totalCount);
     ...
     * @return
     */
    public CommonInfoPropertyDO findCommonInfoProperty(String serviceCode, String zid, String propertyName, String projectId, String custId, String jobId) {
        String sql = "";
        ...
        RowMapper<CommonInfoPropertyDO> rowMapper = new BeanPropertyRowMapper<>(CommonInfoPropertyDO.class);
//        List<Map<String, Object>>List<CommonInfoPropertyDO> infoPropertyDOList = jdbcTemplate.queryForList(sql, CommonInfoPropertyDO.class);
        List<CommonInfoPropertyDO> infoPropertyDOList = jdbcTemplate.query(sql, rowMapper);
    ...
    public List<CommonInfoPropertyDO> findCommonInfoPropertyByzid(String zid) {
    ...
    public List<CommonInfoPropertyDO> findCommonInfoPropertyByProperty(String serviceCode, String propertyName, String propertyValue) {
    ...
    public void settingSettlementPrice(CommonInfoDTO settlmentDTO, LoginUser lu) throws Exception {
        CommonInfoPropertyDO commonInfoPropertyDO = null;
        ...
        List<CommonInfoPropertyDO> infoPropertyDOS = new ArrayList<>();
        //新建
        if (StringUtil.isEmpty(settlmentDTO.getZid())) {
            ...
            for (Map<String, String> o : properties) {
                commonInfoPropertyDO = new CommonInfoPropertyDO();
            ...
            if (settlmentDTO.getServiceCode().equals(CommonInfoServiceCodeEnum.JOB_SETTLEMENT_DETAIL.getKey())
                ...
                CommonInfoPropertyDO propertyDO = findCommonInfoProperty(serviceCode,
    ...
    private void saveCommonPropertyObj(CommonInfoDTO settlmentDTO, Long zid,
                                       List<CommonInfoPropertyDO> infoPropertyDOS, LoginUser lu) {
    ...
    private void addUpdateLog(LoginUser lu, CommonInfoDTO settlmentDTO, Long zid,
                              List<CommonInfoPropertyDO> infoPropertyDOS) {
        JSONObject jsonObject = new JSONObject();
        CommonInfoPropertyDO infoPropertyDO = findCommonInfoProperty(settlmentDTO.getServiceCode(), zid.toString(), "updatePriceLog", null, null, null);
        JSONArray arr = null;
        ...
        if (infoPropertyDO != null) {
            ...
            infoPropertyDO = new CommonInfoPropertyDO();
    ...
    public void jobSelementCommit(String serviceCode, String pid, String isall, String commitStr, LoginUser lu, String remark) throws Exception {
        if (StringUtil.isNotEmpty(isall) && "Y".equals(isall)) {
            List<CommonInfoPropertyDO> list = findCommonInfoPropertyByProperty(serviceCode, "pid", pid);
            for (CommonInfoPropertyDO propertyDO : list) {
        ...
        if (commonInfoDOSb != null && commonInfoDOSb.size() > 0) {
            ...
            for (CommonInfoDO infoDO : commonInfoDOSb) {
                CommonInfoPropertyDO jobSettlementNumDo = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "jobSettlementNum", null, null, null);
                CommonInfoPropertyDO typeObj = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "type", null, null, null);
                ...
                CommonInfoPropertyDO unitPrice = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "unitPrice", null, null, null);
                ...
                if (StringUtil.isEmpty(commonInfoDTO.getJobId())) {
                    CommonInfoPropertyDO jobIdDo = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "jobId", null, null, null);
                    if (jobIdDo != null) commonInfoDTO.setJobId(jobIdDo.getPropertyValue());
                }
                if (StringUtil.isEmpty(commonInfoDTO.getCustId())) {
                    CommonInfoPropertyDO custIdDo = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "custId", null, null, null);
                ...
                if (serviceCode.equals(CommonInfoServiceCodeEnum.PROJECT_SETTLEMENT_DETAIL.getKey())) {
                    if (StringUtil.isEmpty(commonInfoDTO.getProjectId())) {
                        CommonInfoPropertyDO projectIdDo = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "projectId", null, null, null);
                        if (projectIdDo != null) commonInfoDTO.setProjectId(projectIdDo.getPropertyValue());
                    }
                }
                if (StringUtil.isEmpty(billDateStr)) {
                    CommonInfoPropertyDO billDate = findCommonInfoProperty(serviceCode, infoDO.getId().toString(), "billDate", null, null, null);
                    if (billDate != null) {
...
//            map.put("totalPrice", totalPrice.toString());
            ...
            List<CommonInfoPropertyDO> infoPropertyDOS = new ArrayList<>();
            for (String id : idarr) {
                CommonInfoPropertyDO propertyDO = new CommonInfoPropertyDO();
...
//            return jdbcTemplate.queryForObject(sql, CommonInfoDO.class);
    ...
    public void confirmpayJobSettlement(String serviceCode, String id, String paymentTime, String remark, LoginUser lu) throws TouchException {
        ...
        //添加付款信息到property表
        List<CommonInfoPropertyDO> list = new ArrayList<>();
        CommonInfoPropertyDO propertyDO = new CommonInfoPropertyDO();
        ...
        propertyDO = new CommonInfoPropertyDO();
        ...
        CommonInfoPropertyDO batchNoObj = findCommonInfoProperty(serviceCode, id, "batchNo", null, null, null);
        if (batchNoObj != null && StringUtil.isNotEmpty(batchNoObj.getPropertyValue())) {
            List<CommonInfoPropertyDO> propertyDOList = findCommonInfoPropertyByProperty(_servicecode, "batchNo", batchNoObj.getPropertyValue());
            if (propertyDOList != null && propertyDOList.size() > 0) {
                String idStr = "";
                for (CommonInfoPropertyDO propertyObj : propertyDOList) {

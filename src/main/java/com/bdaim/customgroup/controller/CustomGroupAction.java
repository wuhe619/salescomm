...
public class CustomGroupAction extends BasicAction {
    ...
    *//**
    ...
    public String getCustomGroupById(HttpServletRequest request, Integer id) {
        CustomGroupDO custom = customGroupService.getCustomGroupById(id);
...
//        super.operlog(request, (Integer) map.get("id"));
    ...
    *//**
    ...
    public String getCustomGroupByCondition(HttpServletRequest request, CustomGroupDO group,
        ...
        List<CustomGroupDO> groups = customGroupService.getListByCondition(map,
                likeMap, page);
...
//        super.operlog(request, -1);
    ...
    *//**
    ...
    public String addCustomGroup(CustomGroupDO customGroup) {
        Map<String, Object> resultMap = new HashMap<String, Object>();
        LoginUser lu = opUser();
...
//        super.operlog(request, customGroupId);
    ...
    *//**
    ...
    public String download(Integer groupId, HttpServletResponse response,
        ...
        boolean error = false;
        File f = null;
        CustomGroupDO group = customGroupService.getCustomGroupById(groupId);
        if (group == null) {
...
//		}
    ...
    public String customerGroupInfoCoverNum(Integer groupId, HttpServletResponse response) {
        Map<String, Object> resultMap = new HashMap<String, Object>();
        try {
            CustomGroupDO customGroup = customGroupService.getCustomGroupById(groupId);
...
//            super.operlog(request, (null != customGroup.getId()) ? customGroup.getId() : -1);
    ...
    *//**
    ...
    public String getRemainSourceGroupConditionV1(CustomGroupDO customGroup, Integer industryPoolId) {
        LoginUser lu = opUser();
        customGroup.setCreateUserId(lu.getId().toString());
        List<RemainSourceDTO> list = new ArrayList<>();
        Map<String, Object> resultMap = new HashMap<>();
...
//	}
    ...
    *//**
    ...
    public String saveImportCustGroupInfo(@RequestBody JSONObject jsonObject) {
        ...
        int status = customGroupService.saveImportCustGroupData(opUser().getCustId(), name, fileName, headers, projectId);

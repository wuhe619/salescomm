...
public class CustomerGroupProperty {
    ...
    public CustomerGroupProperty() {
    }

    public CustomerGroupProperty(int customerGroupId, String propertyName, String propertyValue, Timestamp createTime) {
    ...
    public boolean equals(Object o) {
        ...
        CustomerGroupProperty that = (CustomerGroupProperty) o;

...
public class LabelDTO {
	...
	public LabelDTO(Integer id, String labelId, String lableName, String businessMean, Integer mutex, Integer type, String typeCn, Integer viewStatus, String path, String uri
...
//		this.labelId=li.getLabelId();
	...
	private List<LabelDTO> children=new ArrayList();


	public void addChild(LabelDTO label) {

 ...
 * UEditor文件上传辅助类
 */
public class Uploader extends BasicAction {
    // 输出文件地址
    private String url = "";
    // 上传文件名
    ...
    // 保存路径
    private String savePath = "emailUpload";
    // 文件允许格式
    ...
    public Uploader(HttpServletRequest request) {
        ...
        tmp.put("SIZE", "文件大小超出限制(请上传2M以内图片)");
    ...
    public void upload() throws Exception {
        ...
        //String cust_id = user.get().getId().toString();
        //savePath=cust_id;
        try {
            ...
            while (fii.hasNext()) {
                ...
                if (!fis.isFormField()) {
                    ...
                    this.url = picUrl + savePath + "/" + this.fileName;
                    BufferedInputStream in = new BufferedInputStream(fis.openStream());
                    File file = new File(upload + savePath + "/" + this.fileName);
